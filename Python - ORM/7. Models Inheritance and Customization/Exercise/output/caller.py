...
from main_app.models import (BaseCharacter, Mage, Assassin, DemonHunter,
                             TimeMage, Necromancer, ViperAssassin, ShadowbladeAssassin,
                             VengeanceDemonHunter, FelbladeDemonHunter,
                             UserProfile, Message,
                             Student, StudentIDField,
                             CreditCard, MaskedCreditCardField,
                             Hotel, Room, SpecialReservation, RegularReservation, BaseReservation)
...
# credit_card4 = CreditCard.objects.create(card_owner="Minka", card_number=2345678901234*46)
