# Generated by Django 4.2.4 on 2023-11-12 18:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_year', models.PositiveIntegerField(validators=[main_app.validators.validate_release_year])),
                ('rating', models.DecimalField(decimal_places=1, max_digits=2, validators=[main_app.validators.validate_rate])),
            ],
        ),
        migrations.CreateModel(
            name='Project',
